    ...
    return (<>
        {currentUser &&
            <form action="#">
                ...
                <div key={currentUser.user_id} className="d-flex flex-column justify-content-center align-items-center gap-4">
                    <div className="d-flex flex-column align-items-center gap-1">
                        <label htmlFor="" className="main-font">Name</label>
                        <input type="text" value={name} onChange={(e) => { setName(e.target.value); setIsNameDisabled(false) }} className="form-control" />
                        <button className="btn btn-primary" disabled={isNameDisabled} onClick={changeName}>Change name</button>
                    </div>
                    <div className="d-flex flex-column align-items-center gap-1">
                        <label htmlFor="" className="main-font">Email</label>
                        <input type="text" value={email} onChange={(e) => { setEmail(e.target.value); setIsEmailDisabled(false) }} className="form-control" />
                        <button className="btn btn-primary" disabled={isEmailDisabled} onClick={changeEmail}>Change email</button>
                    </div>
                    <div className="d-flex flex-column align-items-center gap-1">
                        <label htmlFor="" className="main-font">New password</label>
                        <input type="password" className="form-control" value={password} onChange={(e) => { setPassword(e.target.value); setIsPasswordDisabled(false) }} />
