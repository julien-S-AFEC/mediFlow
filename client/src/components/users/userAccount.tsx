...
const UserAccount: React.FC = () => {
  ...
  const changeName = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("https://mediflow.soutadejulien.com/api/users/changeNameFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
  ...
  const changeEmail = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("https://mediflow.soutadejulien.com/api/users/changeEmailFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
  ...
  const changePassword = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("https://mediflow.soutadejulien.com/api/users/changePasswordFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
