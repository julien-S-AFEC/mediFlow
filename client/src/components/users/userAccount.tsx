...
const UserAccount: React.FC = () => {
  ...
  const changeName = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("soutadejulien.alwaysdata.net/api/users/changeNameFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
  ...
  const changeEmail = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("soutadejulien.alwaysdata.net/api/users/changeEmailFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
  ...
  const changePassword = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    fetch("soutadejulien.alwaysdata.net/api/users/changePasswordFromId", {
      method: "PUT",
      headers: { "Content-type": "application/json" },
      credentials: "include",
      body: JSON.stringify({
