            ...
            >
              <div className="row align-items-center">
                <div className="col-6 pt-3">
                  ...
                  <input type="text" required className="form-control" placeholder="EHPAD Le Clos Fleuri" value={firstname} onChange={(e) => setFirstname(e.target.value)} />
                </div>
                <div className="col-6 pt-3">
                  <label className="form-label">Secondname</label>
                  <input type="text" required className="form-control" placeholder="EHPAD Le Clos Fleuri" value={secondname} onChange={(e) => setSecondname(e.target.value)} />
                </div>
                <div className="col-6 pt-3">
                  <label className="form-label">Institute</label>
                  <input type="text" required className="form-control" placeholder="Green" value={institute} onChange={(e) => setinstitute(e.target.value)} />
                </div>
                <div className="col-6 pt-3">
                  <label className="form-label">Address</label>
                  <input type="text" required className="form-control" placeholder="0658741..." value={address} onChange={(e) => setAddress(e.target.value)} />
                </div>
                <div className="col-6 pt-3">
                ...
                <div className="col-6 pt-3">
                  ...
                  <input type="text" required className="form-control" placeholder="0658741..." value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
              </div>
