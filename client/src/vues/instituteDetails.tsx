                ...
                <div className="d-flex flex-column main-font gap-3 align-items-center w-100">
                    ...
                    {patients && patients.map(patient => (
                        <div key={patient.patient_id}>
                            <a className="d-flex gap-2 justify-content-center text-decoration-none main-font text-dark test" data-bs-toggle="collapse" href={`#patientInfos${patient.patient_id}`} role="button" aria-expanded="false" aria-controls={`patientInfos${patient.patient_id}`}>
